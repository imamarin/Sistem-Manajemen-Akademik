  ...
  * ================================ */
  ...
  , template: function() {
      if (this.options.bsVersion == '2') {
        return '<div class="combobox-container" style="width:100%;"><input type="hidden" /> <div class="input-append" style="width:100%"> <input type="text" autocomplete="off" style="width:100%" /> <span class="add-on dropdown-toggle" data-dropdown="dropdown"> <span class="caret pulldown" style="vertical-align: middle"/> <i class="icon-remove remove"/> </span> </div> </div>'
      } else if (this.options.bsVersion == '3') {
        return '<div class="combobox-container" style="width:100%"> <input type="hidden" /> <div class="input-group" style="width:100%"> <input type="text" autocomplete="off" style="width:100%" /> <span class="input-group-addon dropdown-toggle" data-dropdown="dropdown"> <span class="caret pulldown" /> <span class="glyphicon glyphicon-remove remove" /> </span> </div> </div>'
      } else {
        return '<div class="combobox-container" style="width:100%"> <input type="hidden" /> <div class="input-group" style="width:100%"> <input type="text" autocomplete="off" style="width:100%"/>'
