...
class m_matpelguru extends CI_Model {

	public $table="matpelguru";
    public $id="idmatpelguru";
	...
	public function get_all_join(){
		$this->db->join('guru','guru.kdguru=matpelguru.kdguru');
		$this->db->join('matpel','matpel.kdmatpel=matpelguru.kdmatpel');
		$this->db->join('settahunajaran','settahunajaran.idtahunajaran=matpelguru.idtahunajaran');
		return $this->db->get($this->table);
	}
