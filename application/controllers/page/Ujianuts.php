...
class ujianuts extends CI_Controller {
    function __construct(){
        parent::__construct();
        $this->load->library(array('template','form_validation'));
        $this->load->helper('url');
        $this->session->set_userdata(array('menu'=>'25','katmenu'=>'5'));
    ...
    public function index(){
        ...
        if(isset($this->session->nisn)){
            ...
            $this->template->admin('page/view_ujian_uts_siswa',$data);
        }else{
            $where=array(
            ...
            $data['hapus_action'] = "page/ujianuts/hapus/";
            $this->template->admin('page/view_ujian_uts',$data);
        }
    }
    ...
    function input(){
        ...
        if($this->input->post('input') || $this->input->post('submit')){
            ...
            $data['form_action'] = "page/ujianuts/input";
            $this->template->admin('page/view_nilai_siswa',$data);
        }else{
            redirect('page/ujianuts');
        }
    }
    }
    ...
    public function eksport(){
        if($this->input->post("eksport")){
            ...
            foreach($siswa as $row){ // Ambil semua data dari hasil eksekusi $sql
              ...
              $excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow,  $row->nilai);
            ...
            header('Content-Disposition: attachment; filename="Data Nilai UTS.xlsx"');
