...
class guru extends CI_Controller {
    function __construct(){
        ...
        $this->session->set_userdata(array('menu'=>'2','katmenu'=>'1'));
    }
    

    public function index(){
        $data['guru'] = $this->M_guru->get_all()->result();
        $data['form_action']='page/guru/reset/';
        $this->template->admin('page/view_guru',$data);
    }
    ...
    public function add(){
        ...
        $data['lvl'] = "";
        $data['form_action']='page/guru/simpan/';
    ...
    public function update($pg=NULL){
        if($this->input->post('submit')){
            ...
            $query = $this->M_guru->get_row($where);
            $cek=$query->num_rows();
            $d=$query->row();
            if($cek > 0){
                $data=array(
                ...
                $queri=$this->M_guru->update($where2,$data); 
                if($queri==TRUE){
    ...
    public function hapus($id=NULL){
        ...
        $queri=$this->M_guru->delete($where);
        if($queri==TRUE){
    ...
    public function eksport2(){
        ...
        $excel->setActiveSheetIndex(0)->setCellValue('A1', "DATA GURU"); // Set kolom A1 dengan tulisan "DATA SISWA"
        ...
        $excel->setActiveSheetIndex(0)->setCellValue('B3', "KODE GURU"); 
        ...
        $excel->setActiveSheetIndex(0)->setCellValue('G3', "NUPTK"); 
        $excel->setActiveSheetIndex(0)->setCellValue('H3', "NIP"); 
        ...
        $guru_data = $this->M_guru->get_all_join()->result();
        $no = 1; // Untuk penomoran tabel, di awal set dengan 1
        $numrow = 4; // Set baris pertama untuk isi tabel adalah baris ke 4
        foreach($guru_data as $row){ // Ambil semua data dari hasil eksekusi $sql
          ...
          $excel->setActiveSheetIndex(0)->setCellValue('G'.$numrow,  $row->nuptk);
          $excel->setActiveSheetIndex(0)->setCellValue('H'.$numrow,  $row->nip);
          $excel->setActiveSheetIndex(0)->setCellValue('I'.$numrow,  $row->alamat);
          $excel->setActiveSheetIndex(0)->setCellValue('J'.$numrow,  $row->no_hp);
