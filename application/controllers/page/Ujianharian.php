...
class ujianharian extends CI_Controller {
    function __construct(){
        parent::__construct();
        $this->load->library(array('template','form_validation'));
        $this->load->helper('url');
        $this->session->set_userdata(array('menu'=>'24','katmenu'=>'5'));
    ...
    public function index(){
        ...
        if(isset($this->session->nisn)){
            ...
            $this->template->admin('page/view_ujian_harian',$data);
        }
    ...
    function input(){
        ...
        if($this->input->post('input') || $this->input->post('submit')){
            ...
            $data['form_action'] = "page/ujianharian/input";
    ...
    public function eksport(){
        if($this->input->post("eksport")){
            ...
            header('Content-Disposition: attachment; filename="Data Nilai Ujian Harian.xlsx"');
