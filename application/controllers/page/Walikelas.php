...
class walikelas extends CI_Controller {
    function __construct(){
        ...
        $this->session->set_userdata(array('menu'=>'27','katmenu'=>'6'));
    }
    ...
    public function index($id=NULL){
        ...
        $data['walikelas'] = $this->M_walikelas->get_row($where2)->result();
        $data['form_action']='page/walikelas/simpan';
        $data['hapus_action']='page/walikelas/hapus/';

        $this->template->admin('page/view_walikelas',$data);
    }
    ...
    public function upload()
    {
     ...
     public function eksport($id=NULL){
            include APPPATH.'third_party/PHPExcel.php';
            $excel = new PHPExcel();
            ...
            $walikelas = $this->M_walikelas->get_row($where)->result();
