...
class ujianuas extends CI_Controller {
    function __construct(){
        parent::__construct();
        $this->load->library(array('template','form_validation'));
        $this->load->helper('url');
        $this->session->set_userdata(array('menu'=>'26','katmenu'=>'5'));
    ...
    public function index(){
        ...
        if(isset($this->session->nisn)){
            ...
            $this->template->admin('page/view_ujian_uas_siswa',$data);
        }else{
            $where=array(
            ...
            $data['hapus_action'] = "page/ujianuas/hapus/";
            $this->template->admin('page/view_ujian_uas',$data);
        }
    }
    ...
    function input(){
        ...
        if($this->input->post('input') || $this->input->post('submit')){
            ...
            $data['form_action'] = "page/ujianuas/input";
            $this->template->admin('page/view_nilai_siswa',$data);
        }else{
            redirect('page/ujianuas');
        }
        }
    }
