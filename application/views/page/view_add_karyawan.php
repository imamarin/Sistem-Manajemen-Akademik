        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">
              ...
              ?>
                Input Data Karyawan <?php //echo strtoupper(str_replace("%20"," ",$jdl)); ?>
              <?php
              }
              ?>
              </h1>
            ...
            <div class="card-body">
                          ...
                          <div class="col-12 col-sm-12 col-md-12">
                              <label>Kode Karyawan</label>
                                <div class="select2-blue">
                                  <input type="text" name="kdkaryawan" style="width: 100%;" class="form-control" value="<?= $kdkaryawan ?>" <?= $tidakaktif ?> required>
                                </div>
                          </div>
                      </div><br>                      
                      <div class="row">
                    ...
                    <div class="col-6 col-sm-6 col-md-6">
                      ...
                      <div class="row">
                          <div class="col-12 col-sm-12 col-md-12">
                              <label>NIK</label>
                                <div class="select2-blue">
                                  <input type="text" name="nik" style="width: 100%;" class="form-control" value="<?= $nik ?>" required>
                                </div>
                          </div>
                      </div><br>
                      <div class="row">
                ...
                <fieldset class="scheduler-border">
                  <legend class="scheduler-border">Validasi Pengguna</legend>
                      <?php 
                      if(in_array("Validasi Pengguna-8", $this->session->fitur) || in_array("Tampil Profil-4", $this->session->fitur)){
                        $readonly="";
                      ...
                      <div class="row">
                          <div class="col-12 col-sm-12 col-md-12">
                              <label>Password</label>
                                <div class="select2-blue">
                                  <input type="password" name="password" style="width: 100%;" placeholder="Silahkan input jika mau diganti password" class="form-control" <?= $readonly ?> required>
                                </div>
                          </div>
                      </div><br>
                      <div class="row">
