<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Data Kenaikan Siswa (Raport)</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Data kenaikan Siswa (Raport)</a></li>
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-8">
          <div class="card">
            <!-- /.card-header -->
            <div class="card-body"> 
              INPUT KENAIKAN UNTUK RAPORT SISWA:
              <br><br>
                ...
                <table id="example" class="table table-bordered table-striped dt-responsive " style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>                        
                      ...
                      ?>
                      <select name="naik[]" class="form-control">
                        <option value=1 <?= $n ?>>Naik Kelas/Lulus</option>
                        <option value=2 <?= $tn ?>>Tidak Naik Kelas/Tidak Lulus</option>
                      </select>
