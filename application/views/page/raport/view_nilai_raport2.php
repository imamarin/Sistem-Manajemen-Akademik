          ...
          <div class="card">
            ...
            <div class="card-body"> 
              ...
              <?= form_open($form_action,array("enctype"=>"multipart/form-data")) ?> 
                <?php 
              if(in_array("Eksport Data-49", $this->session->fitur) || in_array("Eksport Data-53", $this->session->fitur) || in_array("Eksport Data-26", $this->session->fitur)){
                ?>
              ...
              ?>            
              <?php 
              if(in_array("Import Data-49", $this->session->fitur)){
                ?>
                ...
                <table id="example" class="table table-bordered table-striped dt-responsive " style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>                        
                      ...
                      <td><?php echo $b->jk; ?></td>
                      <td><input type="text" name="nilai_p[]" class="form-control" value="<?= $nilai_p ?>" required>
                      </td>
                      <td><input type="text" name="nilai_k[]" class="form-control" value="<?= $nilai_k ?>" required>
                      </td>
                    </tr>
                    <?php
                      $no++;                    
