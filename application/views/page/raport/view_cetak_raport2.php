<script type="text/javascript">
  ...
  function cover(g,v,kls,k){
      awal = document.getElementById('start'+k).value;
      akhir = document.getElementById('end'+k).value;
      window.open("<?= base_url().'page/raport/cetak/versi/' ?>"+v+"/cover/"+kls+"/"+awal+"/"+akhir+"/"+g,"_blank");
  }

  function raport1(g,v,kls,k){
      awal = document.getElementById('start'+k).value;
      akhir = document.getElementById('end'+k).value;
      window.open("<?= base_url().'page/raport/cetak/versi/' ?>"+v+"/raport1/"+kls+"/"+awal+"/"+akhir+"/"+g,"_blank");
  }

  function raport2(g,v,kls,k){
      awal = document.getElementById('start'+k).value;
      akhir = document.getElementById('end'+k).value;
      window.open("<?= base_url().'page/raport/cetak/versi/' ?>"+v+"/raport2/"+kls+"/"+awal+"/"+akhir+"/"+g,"_blank");
  }

  function raport3(g,v,kls,k){
      awal = document.getElementById('start'+k).value;
      akhir = document.getElementById('end'+k).value;
      window.open("<?= base_url().'page/raport/cetak/versi/' ?>"+v+"/raport3/"+kls+"/"+awal+"/"+akhir+"/"+g,"_blank");
  }
  ...
  function ranking(v,kls,sms,thn){
      window.open("<?= base_url().'page/raport/cetak/semua/' ?>"+v+"/"+kls+"/"+sms+"/"+thn,"_blank");
  }
                    ...
                    <tr>  
                      ...
                      <td>
                        <div class="row">
                            ...
                            <div class="col-6">
                                <button class="btn btn-success" value="Cover" onclick="cover('<?= $b->kdguru ?>','<?= $cetak[$b->tingkat] ?>','<?= $b->kdkelas ?>','<?= $k ?>');">Cover dan Identitas</button>
                                <button class="btn btn-success" value="raport1" onclick="raport1('<?= $b->kdguru ?>','<?= $cetak[$b->tingkat] ?>','<?= $b->kdkelas ?>','<?= $k ?>');">Raport 1</button>
                                <button class="btn btn-success" value="raport2" onclick="raport2('<?= $b->kdguru ?>','<?= $cetak[$b->tingkat] ?>','<?= $b->kdkelas ?>','<?= $k ?>');">Raport 2</button>
                                <button class="btn btn-success" value="raport3" onclick="raport3('<?= $b->kdguru ?>','<?= $cetak[$b->tingkat] ?>','<?= $b->kdkelas ?>','<?= $k ?>');">Raport 3</button>
