...
<script type="text/javascript">
  function atur(t,x,y,z,th){
    if(t=="hapus"){
        s=window.confirm("Hapus Data ini");
        if(s){
            document.location="<?php echo base_url(); ?>"+"guru/materi/setting/"+t+'/'+x+'/'+y+'/'+z+'/'+th;
        }
    }else{
        document.location="<?php echo base_url(); ?>"+"guru/materi/setting/"+t+'/'+x+'/'+y+'/'+z+'/'+th;
    }
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Informasi Data Guru <?php //echo strtoupper(str_replace("%20"," ",$jdl)); ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="col-12 col-sm-12 col-md-12">
          <div class="card">
            ...
            <div class="card-body">
                ...
                <fieldset class="scheduler-border">
                  <legend class="scheduler-border">Berkas Guru</legend>
