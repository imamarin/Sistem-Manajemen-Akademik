<script type="text/javascript">
  ...
  function edit(x,a,b,c,d,e,f){
    ...
    document.getElementById("title").innerHTML="Edit Ajuan Prakerin";
                ...
                <table id="example1" class="table table-bordered table-striped dt-responsive " style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo strtoupper($b->hp_siswa); ?></td>
                      <td><?php echo strtoupper($b->kdkelas); ?></td>
                      <td><?php echo strtoupper($b->nmperusahaan); ?><br> Kota/Kabupaten: 
                      <?php echo strtoupper($b->kota); ?></td>
                      ...
                      <td>
                        <?php 
                          if($b->status==0){
                            ...
                            ?>
                            <div class="btn-group">
                              <a href="<?= base_url('page/prakerin/cetakajuan/').$b->idpengajuan ?>" target="_blank"><button type="button" class="btn btn-info">Pengambilan Surat</button></a>          
                            </div>
                            <?php
