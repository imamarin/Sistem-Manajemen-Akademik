...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Data Ujian UAS</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Data Ujian uas</a></li>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <?php 
              if(in_array("Tambah Data-26", $this->session->fitur)){
                ?>
                ...
                <table id="example1" class="table table-bordered table-striped dt-responsive " style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>  
                      ...
                      <td>
                        <?php 
                        if(in_array("Hapus Data-26", $this->session->fitur) || in_array("Input Nilai-26", $this->session->fitur)){
                          ?>               
                            <form method="post" action="<?= base_url()."page/ujianuas/input/" ?>">
      ...
      <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            <form method="post" action="<?= base_url().'page/ujianuas/simpan' ?>" enctype="multipart/form-data">
            <div class="modal-header">
              <h4 class="modal-title">TAMBAH DATA UJIAN uas</h4>
