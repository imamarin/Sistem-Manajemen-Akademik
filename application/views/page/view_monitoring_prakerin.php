                      ...
                      <td><?= $no ?>
                        <div class="modal fade" id="cekanggota<?= $no ?>">
                            ...
                            <div class="modal fade" id="laporMonitoring<?= $no ?>">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <form method="post" action="<?= base_url().'page/prakerin/monitoring' ?>" enctype="multipart/form-data">
                                  <div class="modal-header">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="row">
                                      <div class="col-sm-12 col-md-12">
                                        ...
                                        <input type="date" name="tglmonitoring" class="form-control" value="<?= date('Y-m-d',strtotime($b->tglmonitoring)) ?>" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                      <div class="col-sm-12 col-md-12">
                                        <label>Deskripsi Hasil Monitoring</label>
                                        <textarea name="deskripsi" class="form-control" rows="15" id="summernote<?= $no ?>" required><?= $b->deskripsi ?></textarea>
                                        </div>
                                        <script>
                                  ...
                                  <div class="modal-footer justify-content-between">
                                    <input type="hidden" name="idpengajuan" value="<?= $b->idpengajuan ?>">
                                    <input type="hidden" name="kdguru" value="<?= $b->kdguru ?>">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>

                                    <button type="submit" name="submit" value="simpan" class="btn btn-primary">Kirim</button>
                                  </div>
                                </form>
                                </div>
                                <!-- /.modal-content -->
